...
const EditWorkPlanItemModal = ({ item, onClose, onSuccess }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await ApiService.updateWorkPlanItem(item.id, payload);
            toast.success('Пункт плана успешно обновлен!');
            onSuccess();
            onClose();
        } catch (error) {
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 backdrop-blur-sm flex justify-center items-center z-[10000]">
            <div className="bg-white rounded-lg shadow-xl p-6 w-full max-w-lg">
                <div className="flex justify-between items-center mb-4">
                    <h2 className="text-xl font-bold">Редактировать пункт плана</h2>
...
export default EditWorkPlanItemModal;
